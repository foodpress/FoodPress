...
$foodpress_custom_language_array = array(
	...
	array('type'=>'togheader','name'=>'General Menu'),
		...
		array(
			...
			'label'=>__('protein','foodpress'),'name'=>__('protein','foodpress'),
		),
		// custom meta fields		
	...
	array('type'=>'togheader','name'=>__('Other General','foodpress'),),
		array('label'=>__('Location','foodpress'),'name'=>__('location','foodpress'),'legend'=>''),
		array('type'=>'togend'),
	...
	array('type'=>'togheader','name'=>__('Reservation Form','foodpress'),),
		...
		array('label'=>__('Time Placeholder','foodpress'),'name'=>'fp_lang_resform_A4C','placeholder'=>__('12:00','foodpress'),),
		array('label'=>__('Start Time Placeholder','foodpress'),'name'=>'fp_lang_resform_A4A','placeholder'=>__('1:00','foodpress'),),
		array('label'=>__('End Time Placeholder','foodpress'),'name'=>'fp_lang_resform_A4B','placeholder'=>__('2:00','foodpress'),),
		...
		array('label'=>__('Phone Number','foodpress'),'name'=>'fp_lang_resform_004d'),
