		...
		function appearnace(){
			return apply_filters('foodpress_settings_appearances',
				array(
					...
					array('id'=>'fp_font_fam','type'=>'text','name'=>'Primary Font family <br/><i>(Note: type the name of the font that is supported in your website. eg. Arial)</i>'),
