...
/**
 *
 * foodpress update and licensing class
 *
 * @author 		AJDE
 * @category 	Admin
...
class fp_updater{
	...
	public function fp_check_info($false, $action, $args){
	...
	// check purchase code correct format
		public function purchase_key_format($key, $type='foodpress'){
			if(!strpos($key, '-'))
				return false;
